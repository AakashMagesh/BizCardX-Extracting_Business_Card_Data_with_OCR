...
icon = Image.open("D:\\Bizcardx_Project\\bussines_cards.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Aakash Magesh",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *AAKASH MAGESH*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("D:\\Bizcardx_Project\\bussines_cards.png"), width=500)
